...
export NODE_VETH_ADDR="10.200.1.11"
export NODE_VPEER_ADDR="10.200.1.100"
# export NODE_GENEVE_ADDR="10.200.1.10" # Create gevene interface for decapsulation
export NODE_GENEVE_REMOTE_ADDR="10.20.20.2" # this is the address of eth0 on node2
export NODE_GENEVE_REMOTE_CIDR="10.200.2.0/24" # Geneve CIDR
